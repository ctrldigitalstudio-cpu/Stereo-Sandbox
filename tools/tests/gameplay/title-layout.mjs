...
const sizes = [[1280, 720], [400, 800], [640, 360], [960, 540], [320, 568], [1920, 1080]];
...
for (const offline of [false, true]) {
  for (const [w, h] of offline ? [[1280, 720], [400, 800]] : sizes) {
    ...
    if (w <= 560) check(m.words.length === 2 && m.words[1][1] > m.words[0][1], `${tag}: words stack on narrow screens`);
