...
import { startServer, launch, newGamePage, waitReady, frames, reporter, sleep, captureSettled, LIGHT_SETTINGS, SETTINGS_KEY, SAVE_KEY } from './lib.mjs';
...
const cycleMenus = async () => {
  ...
  await page.waitForFunction(() => window.__game.state === 'playing');
  await captureSettled(page, [200, 112]);
};
