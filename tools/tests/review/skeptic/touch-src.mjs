...
// natural spawn view without forcing pitch
lg('state at end: ' + await page.evaluate(() => __game.state));
lg('hud buttons: ' + await page.evaluate(() => document.querySelectorAll('.hud button').length));
